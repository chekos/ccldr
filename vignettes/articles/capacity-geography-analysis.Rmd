...
The printed tables and chart previews below are representative outputs. Your
counts will change as CCLD records, closure dates, and geocoding matches change.
...
![Horizontal bar chart of total licensed preschool capacity by city.](figures/capacity-city-bars.svg)
...
![Scatterplot comparing open facility count and total licensed capacity by city.](figures/capacity-city-scatter.svg)
...
![Horizontal bar chart of highest-capacity ZCTAs.](figures/capacity-zcta-bars.svg)
...
![Horizontal bar chart of highest-capacity Census tracts.](figures/capacity-tract-bars.svg)
...
![Small-multiple line chart of closed capacity records by city and year.](figures/capacity-closed-lines.svg)
